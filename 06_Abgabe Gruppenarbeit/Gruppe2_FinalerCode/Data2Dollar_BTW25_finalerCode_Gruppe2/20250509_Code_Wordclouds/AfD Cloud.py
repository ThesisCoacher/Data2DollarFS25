...
print(f"Found {afd_speeches} speeches from AfD")
print(f"Processed speeches found {len(freq)} matching terms in whitelist")

if len(freq) == 0:
    raise ValueError("No matching terms found for AfD speeches. Cannot generate wordcloud.")

# 3) WordCloud konfigurieren (16:9) mit AfD-Blau
afd_blue = "#0489DB"
...
plt.savefig('afd_wordcloud.png')  # Save to file
print("Wordcloud saved as 'afd_wordcloud.png'")
plt.show()
