...
# 2) Häufigkeiten aus SPD-Reden zählen
freq = Counter()
...
try:
    ...
    print(f"Processed speeches from SPD. Found {len(freq)} matching terms.")
    
    # 3) WordCloud konfigurieren (16:9) mit SPD-Rot
    spd_red = "#E3000F"
    ...
    plt.savefig('spd_wordcloud.png')  # Save to file
    print("Wordcloud saved as 'spd_wordcloud.png'")
    plt.show()
